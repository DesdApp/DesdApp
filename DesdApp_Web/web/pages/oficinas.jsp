...
<body>
        ...
        <div id="cont" class="container-fluid">
                <img src="../img/let.PNG" width="200px" height="200px" class="rounded float-left" alt="...">
            </div>
            <div class="fondo conetainer-fluid form-row col-lg-16 d-flex">
                <div class="header-mobile houzez-header-mobile btn btn-group btn-block">
                    <button class="btn btn-block btn fondo ronder-top text-light" type="button" name="btnInicio"><a href="../pages/inicio.jsp">Inicio</a></button>
