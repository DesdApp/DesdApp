...
<%@page import="dao.DAOCorredores"%>
<%@page import="modelo.Corredores"%>
...
<body class="bg">
    ...
    <%
        ...
        ArrayList<Corredores> list = new ArrayList<>();
        
    %>
    
    <div class="row d-flex- justify-content-center">
        <a href="ServletCorredor?accion=cards"></a>
        <!-- Card numero 1 -->
        <div class="card mb-3 col-5 p-2">
            <div class="row no-gutters">
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        <h4 class="card-title" name="tipop">Card title</h4>
                        <h5 name="direccion">Dirección</h5>
                        <h5 name="zona">Zona</h5>
                        <h5 name="precio">Precio</h5>
