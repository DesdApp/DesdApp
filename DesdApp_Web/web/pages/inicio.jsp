...
--%>
    ...
    <%@page contentType="text/html" pageEncoding="UTF-8"%>
        ...
        <body class="bg">
            ...
            <div class="container">
                <div class="row ">
                    <div class="col-12" style="margin-top: 6px ; height: 170px; display: flex; justify-content: center; align-items: center">
                                        ...
                                        <div class="col-4">
                                            <div class="espacioCard card mt-5 mb-3" style="width: 18rem;">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text">CASA EN KM.13 RUTA AL SALVADOR PRECIO $525,000 Negociable</p>
                                        ...
                                        <div class="col-4 float-left">
                                            <div class="espacioCard card mt-5 mb-3" style="width: 18rem;">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text">RENTO CASA EN CONDOMINIO SANTA ANITA PRECIO Q.5,500.00 incluye Mantenimiento.</p>
                                                    <a href="#" class="btn colorBt botonCard btn-primary">Detalles</a>
                                                </div>
                                                <div class="card" style="width: 18rem;">
                                                    <div class="card-header">
                                        ...
                                        <div class="col-4 float-left">
                                            <div class="espacioCard card mt-5 mb-3" style="width: 18rem;">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text">Casa - Condominio Santa Anita Guatemala Precio: $128,000 Negociable poco</p>
