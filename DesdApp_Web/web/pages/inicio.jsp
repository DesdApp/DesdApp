...
<body class="bg">
    ...
    <div class="primary conetainer-fluid form-row col-lg-16 d-flex">
        <div class="header-mobile houzez-header-mobile btn btn-group btn-block">
            ...
            <div class="btn-group btn-block">
                <button class="btn primary text-light dropdown-toggle" type="button" data-toggle="dropdown"
                    aria-haspopup="true" aria-expanded="false">
                    Quienes somos
                </button>
                <div class="bt dropdown-menu">
                    <a class="bt dropdown-item" href="../pages/nosotros.jsp">Nuestro Equipo</a>
                    <a class="bt dropdown-item" href="../pages/oficinas.jsp">Oficinas</a>
                </div>
            </div>
            ...
            <button class="btn btn-block btn primary ronder-top text-light" type="button"
                name="btnContac">Contáctenos</button>
            <button class="btn btn-block btn fondo ronder-top text-light" type="button" name="btnSesion">Iniciar
                Sesion/Registrarse</button>
        </div>
    </div>
    <!--Banner-->
    ...
    <div class="container-fluid col-8 bt mt-4 d-flex">
        <!--Card1-->
